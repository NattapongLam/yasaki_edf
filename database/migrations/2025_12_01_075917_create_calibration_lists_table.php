...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('calibration_lists', function (Blueprint $table) {
            ...
            $table->decimal('calibration_lists_areaofuse', 18, 2)->default(0);
            $table->decimal('calibration_lists_measuringrange', 18, 2)->default(0);
            $table->decimal('calibration_lists_precision', 18, 2)->default(0);
            $table->decimal('calibration_lists_resolution', 18, 2)->default(0);
