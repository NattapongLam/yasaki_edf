...
<div class="card">
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-12 col-md-3"><h3 class="card-title">บิลขาย</h3></div>
            <div class="col-12 col-md-9">
                <!-- ฟอร์มเลือกช่วงวันที่ -->
                <form action="{{ route('saleorders.index') }}" method="GET" class="row g-2 justify-content-end">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="{{ route('saleorders.index') }}" class="btn btn-light">เดือนนี้</a>
                    </div>
                    <div class="col-auto">
                        <a href="{{route('saleorders.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> เพิ่มรายการ</a>
                    </div>
                </form>
            </div>
        </div>       
