...
<div class="card">
    <div class="card-body">
        <form method="POST" class="form-horizontal" action="{{ route('quotations.update',$hd->ar_quotation_hds_id) }}" enctype="multipart/form-data">
        @csrf      
        @method('PUT')
        <div class="row">
            ...
            <div class="col-3">
                <div class="form-group">
                   ...
                   <input type="date" class="form-control" 
                            ...
                            value="{{$hd->ar_quotation_hds_date }}" 
                            required>
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                   ...
                   <input type="text" class="form-control" 
                            ...
                            value="{{$hd->ar_quotation_hds_docuno}}"
                            readonly>
                </div>
            </div>
            <div class="col-3">
                ...
                <div class="form-group">
                    ...
                    <select class="form-select" name="ar_requestorder_hds_id" id="ar_requestorder_hds_id" required>
                        ...
                        @foreach ($orders as $item)
                            <option value="{{$item->ar_requestorder_hds_id}}"
                                 {{ $item->ar_requestorder_hds_id == $hd->ar_requestorder_hds_id ? 'selected' : '' }}>
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input class="form-control" type="hidden" name="ar_customer_lists_code" id="ar_customer_lists_code" value="{{$hd->ar_customer_lists_code}}">
                    <input class="form-control" type="hidden" name="ar_customer_lists_name" id="ar_customer_lists_name" value="{{$hd->ar_customer_lists_name}}">
                </div>
            </div> 
            <div class="col-3">
                <div class="form-group">
                    <label for="ar_customer_lists_contact" class="col-form-label">ผู้ติดต่อ</label>
                    <input class="form-control" type="text" name="ar_customer_lists_contact" id="ar_customer_lists_contact" value="{{$hd->ar_customer_lists_contact}}">
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                    <label for="ar_customer_lists_tel" class="col-form-label">เบอร์โทร</label>
                    <input class="form-control" type="text" name="ar_customer_lists_tel" id="ar_customer_lists_tel" value="{{$hd->ar_customer_lists_tel}}">
                </div>
            </div>  
        </div>
        <div class="row">
              <div class="col-9">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="ar_customer_lists_address" id="ar_customer_lists_address" value="{{$hd->ar_customer_lists_address}}">
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                    ...
                    <select class="form-select" name="acc_currencies_id" id="acc_currencies_id" required>
                        @foreach ($currencys as $item)
                            <option value="{{$item->acc_currencies_id}}"
                                ...
                                {{$item->acc_currencies_name}}</option>
                        @endforeach
                    </select>
                </div> 
            </div>
        ...
        <div class="row">
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="ar_customer_lists_email" id="ar_customer_lists_email" value="{{$hd->ar_customer_lists_email}}">
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                    <label for="ar_customer_lists_credit" class="col-form-label">วันเครดิต</label>
                    <input class="form-control" type="text" name="ar_customer_lists_credit" id="ar_customer_lists_credit" value="{{$hd->ar_customer_lists_credit}}">
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                    <label for="ar_customer_lists_taxid" class="col-form-label">เลขประจำตัวผู้เสียภาษี</label>
                    <input class="form-control" type="text" name="ar_customer_lists_taxid" id="ar_customer_lists_taxid" value="{{$hd->ar_customer_lists_taxid}}">
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                ...
                <tbody id="tableBody">
                     @foreach ($dt as $item)
                        <tr>
                            ...
                            <td><input type="text" name="ar_quotation_dts_qty[]" class="form-control qty-input" value="{{number_format($item->ar_quotation_dts_qty, 2, '.', '')}}"/></td>
                            <td><input type="text" name="ar_quotation_dts_price[]" class="form-control price-input" value="{{number_format($item->ar_quotation_dts_price, 2, '.', '')}}"/></td>
                            <td><input type="text" name="acc_discount_qty[]" class="form-control dis-input" value="{{number_format($item->acc_discount_qty, 2, '.', '')}}"/></td>
                            <td><input type="text" name="ar_quotation_dts_amount[]" class="form-control amount-input" value="{{number_format($item->ar_quotation_dts_amount, 2, '.', '')}}" readonly/></td>
                            <td>
                                <input type="text" name="ar_quotation_dts_remark[]" class="form-control" value="{{$item->ar_quotation_dts_remark}}"/>
                                <input type="hidden" name="ar_quotation_dts_base[]" class="form-control base-input" value="{{number_format($item->ar_quotation_dts_base, 2, '.', '')}}"/>
                                <input type="hidden" name="ar_quotation_dts_vat[]" class="form-control vat-input" value="{{number_format($item->ar_quotation_dts_vat, 2, '.', '')}}"/>
                                <input type="hidden" name="ar_quotation_dts_net[]" class="form-control net-input" value="{{number_format($item->ar_quotation_dts_net, 2, '.', '')}}"/>
                                <input type="hidden" name="ar_quotation_dts_dis[]" class="form-control distotal-input" value="{{number_format($item->ar_quotation_dts_dis, 2, '.', '')}}"/>
                            </td>
                            <td></td>
                        </tr>
                    @endforeach
            ...
            <div class="col-3">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <h4 class="mb-0" id="sum-subtotal">{{number_format($hd->ar_quotation_hds_base, 2, '.', '')}}</h4>
                        <input id="ar_quotation_hds_base" name="ar_quotation_hds_base" type="hidden" value="{{number_format($hd->ar_quotation_hds_base, 2, '.', '')}}">
                    </div>
            ...
            <div class="col-3">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <h4 class="mb-0" id="sum-vat">{{number_format($hd->ar_quotation_hds_vat, 2, '.', '')}}</h4>
                        <input id="ar_quotation_hds_vat" name="ar_quotation_hds_vat" type="hidden" value="{{number_format($hd->ar_quotation_hds_vat, 2, '.', '')}}">
                    </div>
                    <div class="flex-shrink-0 align-self-center">
                        <div class="avatar-sm rounded-circle bg-primary mini-stat-icon">
                            <span class="avatar-title rounded-circle bg-primary">
            ...
            <div class="col-3">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <h4 class="mb-0" id="sum-discount">{{number_format($hd->ar_quotation_hds_dis, 2, '.', '')}}</h4>
                        <input id="ar_quotation_hds_dis" name="ar_quotation_hds_dis" type="hidden" value="{{number_format($hd->ar_quotation_hds_dis, 2, '.', '')}}">
                    </div>
                    <div class="flex-shrink-0 align-self-center">
                        <div class="avatar-sm rounded-circle bg-primary mini-stat-icon">
                            <span class="avatar-title rounded-circle bg-primary">
            ...
            <div class="col-3">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <h4 class="mb-0" id="sum-grandtotal">{{number_format($hd->ar_quotation_hds_net, 2, '.', '')}}</h4>
                        <input id="ar_quotation_hds_net" name="ar_quotation_hds_net" type="hidden" value="{{number_format($hd->ar_quotation_hds_net, 2, '.', '')}}">
                    </div>
                    <div class="flex-shrink-0 align-self-center">
                        <div class="avatar-sm rounded-circle bg-primary mini-stat-icon">
                            <span class="avatar-title rounded-circle bg-primary">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <textarea class="form-control" name="ar_quotation_hds_remark" id="ar_quotation_hds_remark">{{$hd->ar_quotation_hds_remark}}</textarea>
            </div>
        </div>  
        <br>
