         ...
         <div class="row mt-3">
            ...
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input type="hidden" name="acc_typevats_id" id="acc_typevats_id_hidden">
                </div> 
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input type="hidden" name="acc_currencies_id" id="acc_currencies_id_hidden">
                </div> 
            </div>
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input type="hidden" name="acc_discount_id" id="acc_discount_id_hidden">
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input class="form-control" name="ar_customer_lists_id" id="ar_customer_lists_id" type="hidden" readonly>
                </div>
            </div>
        </div> 
        <div class="row mt-3">
