...
<div class="card">
    <div class="card-body">
        <form method="POST" class="form-horizontal" action="{{ route('machinerylists.store') }}" enctype="multipart/form-data">
        @csrf   
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="machinery_lists_code" required>
                </div>               
            </div>
            <div class="col-6">
                <div class="form-group">
                    <label for="machinery_lists_name1" class="col-form-label">ชื่อเครื่องจักร (ภาษาไทย)</label>
                    <input type="text" class="form-control" name="machinery_lists_name1" required>
                </div>               
            </div>
        </div>  
        <div class="row">
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="machinery_lists_serialno">
                </div>               
            </div>
            <div class="col-3">
                <div class="form-group">
                    <label for="machinery_lists_brand" class="col-form-label">ยี่ห้อ</label>
                    <input type="text" class="form-control" name="machinery_lists_brand">
                </div>               
            </div>
            <div class="col-6">
                <div class="form-group">
                    <label for="machinery_lists_name2" class="col-form-label">ชื่อเครื่องจักร (ภาษาอังกฤษ)</label>
                    <input type="text" class="form-control" name="machinery_lists_name2">
                </div>               
            </div>
        </div>
        <div class="row">
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="machinery_lists_date">
                </div>               
            </div>
            <div class="col-3">
                <div class="form-group">
                    <label for="machinery_lists_expirationdate" class="col-form-label">วันที่หมดประกัน</label>
                    <input type="date" class="form-control" name="machinery_lists_expirationdate">
                </div>               
            </div>
            <div class="col-3">
                <div class="form-group">
                    <label for="machinery_lists_plandate" class="col-form-label">วันที่ PM ล่าสุด</label>
                    <input type="date" class="form-control" name="machinery_lists_plandate">
                </div>               
            </div>
            <div class="col-3">
                <div class="form-group">
                    <label for="machinery_lists_nextdate" class="col-form-label">วันที่ PM ขั้นต่อไป</label>
                    <input type="date" class="form-control" name="machinery_lists_nextdate">
                </div>               
            </div>
        </div>
        <div class="row">
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="machinery_lists_day">
                </div>               
            </div>
            <div class="col-3">
                <div class="form-group">
                    <label for="machinery_lists_location" class="col-form-label">สถานที่ตั้ง</label>
                    <input type="text" class="form-control" name="machinery_lists_location">
                </div>               
            </div>
            <div class="col-6">
                <div class="form-group">
                    <label for="machinery_lists_reamrk" class="col-form-label">หมายเหตุ</label>
                    <input type="text" class="form-control" name="machinery_lists_reamrk">
                </div>               
            </div>
        </div>
        <div class="row">
