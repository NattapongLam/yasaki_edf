...
<div class="card">
    <div class="card-body">
        <form method="POST" class="form-horizontal" action="{{ route('machinerychecksheets.store') }}" enctype="multipart/form-data">
        @csrf 
        <div class="row">
        ...
        <div class="row">
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" 
                        ...
                        id="machinery_checksheet_hds_date" required>
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input class="form-control" value="{{$hd->machinery_lists_name1}}" name="machinery_lists_name" readonly>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input class="form-control" name="machinery_checksheet_hds_remark">
                </div>
            </div>
        </div>
        <br>
...
@push('scriptjs')
<script>
document.getElementById('machinery_checksheet_hds_date').addEventListener('change', function () {
