...
<div class="card">
    <div class="card-body">
        <form method="POST" class="form-horizontal" action="{{ route('purchaseorders.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
        ...
        <div class="row">
            <div class="col-3">
                <div class="form-group">
                   ...
                   <input type="date" class="form-control" 
                            ...
                            value="{{ old('ap_purchaseorder_hds_date', now()->format('Y-m-d')) }}" 
                            required>
                </div>
            </div>
            <div class="col-3">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="hidden" name="ap_vendor_lists_code" id="ap_vendor_lists_code">
                    <input type="hidden" name="ap_vendor_lists_name" id="ap_vendor_lists_name">
                </div>
            </div>
        </div>
        <div class="row">    
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input class="form-control" name="ap_vendor_lists_taxid" id="ap_vendor_lists_taxid" readonly>
                </div>
            </div> 
            <div class="col-3">
                <div class="form-group">
                    <label for="ap_vendor_lists_email" class="col-form-label">Email</label>
                    <input class="form-control" type="text" name="ap_vendor_lists_email" id="ap_vendor_lists_email">                   
                </div>
            </div>       
            <div class="col-6">
                <div class="form-group">
                    <label for="ap_vendor_lists_address" class="col-form-label">ที่อยู่</label>
                    <input class="form-control" name="ap_vendor_lists_address" id="ap_vendor_lists_address" readonly>
                </div>
            </div>           
        </div>
        <div class="row">
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="ap_vendor_lists_contact" id="ap_vendor_lists_contact">
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                    <label for="ap_vendor_lists_tel" class="col-form-label">เบอร์โทร</label>
                    <input class="form-control" type="text" name="ap_vendor_lists_tel" id="ap_vendor_lists_tel">
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                    <label for="ap_vendor_lists_credit" class="col-form-label">วันเครดิต</label>
                    <input class="form-control" type="text" name="ap_vendor_lists_credit" id="ap_vendor_lists_credit">
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
            ...
            <div class="col-3">
             ...
             <div class="col-6">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="ap_purchaseorder_hds_remark" id="ap_purchaseorder_hds_remark">
                </div>
             </div>
        </div>
        <br>
            ...
            <div class="col-3">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <input id="ap_purchaseorder_hds_base" name="ap_purchaseorder_hds_base" type="hidden">
                    </div>
            ...
            <div class="col-3">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <input id="ap_purchaseorder_hds_vat" name="ap_purchaseorder_hds_vat" type="hidden">
                    </div>
                    <div class="flex-shrink-0 align-self-center">
                        <div class="avatar-sm rounded-circle bg-primary mini-stat-icon">
                            <span class="avatar-title rounded-circle bg-primary">
            ...
            <div class="col-3">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <input id="ap_purchaseorder_hds_dis" name="ap_purchaseorder_hds_dis" type="hidden">
                    </div>
                    <div class="flex-shrink-0 align-self-center">
                        <div class="avatar-sm rounded-circle bg-primary mini-stat-icon">
                            <span class="avatar-title rounded-circle bg-primary">
            ...
            <div class="col-3">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <input id="ap_purchaseorder_hds_net" name="ap_purchaseorder_hds_net" type="hidden">
                    </div>
                    <div class="flex-shrink-0 align-self-center">
                        <div class="avatar-sm rounded-circle bg-primary mini-stat-icon">
                            <span class="avatar-title rounded-circle bg-primary">
...
<script>
function loadDocNo() {
    let docDate = $("#ap_purchaseorder_hds_date").val();
        if (docDate) {
            $.ajax({
                url: "{{ route('purchaseorder.runno') }}",
                type: "GET",
                data: { date: docDate },
                success: function (res) {
                    $("#ap_purchaseorder_hds_docuno").val(res.docno);
                }
            });
        }
    }
    // ✔ ทำงานเมื่อผู้ใช้เปลี่ยนวันที่
    $("#ap_purchaseorder_hds_date").on('change', function () {
        loadDocNo();
    });
...
function canEditRow(row) {
    ...
    if (!row.find("select[name='ap_purchaserequest_dts_id[]']").val() ||
        row.find("select[name='ap_purchaserequest_dts_id[]']").val() == 0) {
