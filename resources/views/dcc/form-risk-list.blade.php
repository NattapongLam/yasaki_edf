...
<div class="card">
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-12 col-md-6"><h3 class="card-title">ความเสี่ยงและโอกาส</h3></div>
            <div class="col-12 col-md-6"><a style="float: right" href="{{route('risk.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> เพิ่มรายการ</a></div>
        </div>             
